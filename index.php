   ...
   <div class="main-section">
        <div class="containers" style="border-color: white;">
         <div class="photo" style="border-color: white;" >
          ...
          <span class="set" style="color: white;">I'm </span><span class="malarkey" style="color: red;"></span><span id="hide" style="color: white;">|</span>    
           <script src="/index.html/js/malarkey.min.js"></script>
    <script>
    ...
    var m = malarkey(elem, opts).type(' an Indian.').pause().delete()
    ...
    document.addEventListener('click', function() {
      if (m.isRunning()) {
        ...
        elem.style.color = 'black';
          ...
          <h1 class="about-me" style="color: white; font-size: 20px; font-family:"Palatino Linotype", "Book Antiqua", Palatino, serif;">
            My_self Harshit Omer.I’m an Undergraduate student, pursuing bachelor of technology degree in Computer Science and Engineering. I expect to graduate with a Bachelors degree in May 2019. I love to play with web technologies and create great user experiences.
          </h1>
        </div>
        ...
        <div class="project-head">
           <a><span class="h2" style="color: white; text-align: center;">Fun Skills/Projects</span></a>
        </div>
        <div class="row">
          <div class="col s12 m12 l4">
            ...
            <div class="col s12 m12 l12 box-content" style="color: black;">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
            <h5 class="box-title" style="color: black;">2. Sudoku</h5>
              <div class="col s12 m12 l12 box-image">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">3. Solitaire Games</h5>
              <div class="col s12 m12 l12 box-image">
        ...
        <div class="row">
          <div class="col s12 m12 l4">
            <div class="row box">
            <h5 class="box-title" style="color: black;">4.Cube</h5>
              <div class="col s12 m12 l12 box-image">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">5.Asphalt </h5>
              <div class="col s12 m12 l12 box-image">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">6.Philosophy</h5>
              <div class="col s12 m12 l12 box-image">
        ...
        <div class="row">
          <div class="col s12 m12 l4">
            <div class="row box">
            <h5 class="box-title" style="color: black;">7. Writter</h5>
              <div class="col s12 m12 l12 box-image">
         ...
         <p style="color:white; font-size:30px; text-align: center; margin-bottom: 30px">Future Projects</p>
         <div style="max-height:100%">
         <div id='stars'></div>
         <div id='stars2'></div>
         <div id='stars3'></div>
         ...
         <div class="row">
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">8. Octo Game</h5>
               <div class="col s12 m12 l12 box-image">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">9. Abhivyakti 2k18</h5>
              <div class="col s12 m12 l12 box-image">
          ...
          <div class="col s12 m12 l4">
            <div class="row box">
              <h5 class="box-title" style="color: black;">11. Laptop Selfi</h5>
              <div class="col s12 m12 l12 box-image">
        ...
        <div class="row">
          <div class="col s12 m12 l4">
            <div class="row box">
             <h5 class="box-title" style="color: black;">13. Gantavya 2k18</h5>
              <div class="col s12 m12 l12 box-image">
         ...
         <div class="col s12 m12 l4">
            <div class="row box">
             <h5 class="box-title" style="color: black;">14. Notification Panel</h5>
              <div class="col s12 m12 l12 box-image">
